...
-1.414 1.414l-4.816-4.816A6 6 0 012 8z"
            ...
            <Typed
              strings={[
                "Find out the Universities that have partnered with AdmitKard....",
              ]}
              typeSpeed={15}
              backSpeed={15}
              attr="placeholder"
            ...
            >
              <input
                className="relative w-full p-2 pl-10 rounded-md text-gray-900 placeholder-gray-500 border shadow border-gray-300 focus:outline-none focus:border-blue-300"
                type="text"
                placeholder="Search..."
                value={searchText}
